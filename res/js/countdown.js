$(function () {
	...
	$('#countdown').countdown({until: date_ouverture_matin, compact: true, onExpiry: function(){location.reload();}, layout: '<div id=\'until\'><div id=\'cd\'><span id=\'cd_days\'>{dnn}</span></div><div id=\'cd\'><span id=\'cd_hours\'>{hnn}</span></div><div id=\'cd\'><span id=\'cd_minutes\'>{mnn}</span></div><div id=\'cd\'><span id=\'cd_seconds\'>{snn}</span></div></div>'});
	$('#countdown2').countdown({until: debut_countdown_soir, compact: true, onExpiry: function(){location.reload();}});
	$('#countdown3').countdown({until: date_ouverture_soir, compact: true, onExpiry: function(){location.reload();}, layout: '<div id=\'until\'><div id=\'cd\'><span id=\'cd_days\'>{dnn}</span></div><div id=\'cd\'><span id=\'cd_hours\'>{hnn}</span></div><div id=\'cd\'><span id=\'cd_minutes\'>{mnn}</span></div><div id=\'cd\'><span id=\'cd_seconds\'>{snn}</span></div></div>'});
